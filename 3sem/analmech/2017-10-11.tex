  ...
  \item
  \begin{flalign*}
  & \overline a' = (\cos \frac{\varphi}{2} + e\sin\frac{\varphi}{2} \circ \overline a \circ (\cos \frac{\varphi}{2} + \overline e \sin \frac{\varphi}{2}) = &\\ 
  ...
  \end{equation}
  \begin{df}
  Функция $\Phi(\overline x, t)$ называется первыим интегралом системы \re{upper_system}, если
  \[ \Phi(\overline x(t), t) = const \]
  где $\overline x(t)$ --- решение системы \re{upper_system}
  \end{df}
  \begin{ass}
  Система \re{c.1} имеет первый интерграл вида
  \[\norm \Lambda = const \]
  \end{ass}
  \begin{proof}
